...
export const siteConfig = {
  ...
  // ─── Site Metadata ────────────────────────────────────────────────────────
  site: {
    name: "Christina Wood — Health & Wellness",
    description:
      "Christina Wood is a Certified Health & Wellness Coach helping clients achieve optimal health through personalized, root-cause coaching and sustainable lifestyle changes.",
  ...
  // ─── SchemaOrg defaults ───────────────────────────────────────────────────
  schema: {
    name: "Christina Wood — Health & Wellness Coach",
    description:
